...
const seed = async () => {
  try {
    ...
    const users = [
      ...
      { id: 'u0000000-0000-0000-0000-000000000002', full_name: 'Downtown Manager', username: 'manager', email: 'ma@gmail.com', password_hash: '123', role: 'manager', ShopId: shopsData[1].id, is_active: 1 },
      { id: 'u0000000-0000-0000-0000-000000000003', full_name: 'Expert Cashier', username: 'cashier', email: 'sh@gmail.com', password_hash: '123', role: 'cashier', ShopId: shopsData[1].id, is_active: 1 }
    ];
    ...
    const productsData = [
      { name: 'Smartphone X', purchasePrice: 500000, sellingPrice: 750000, barcode: '88001122', CategoryId: catMap['Electronics'], BrandId: brandMap['Sony'] },
      { name: 'Cold Soda 500ml', purchasePrice: 1200, sellingPrice: 1500, barcode: '11223344', CategoryId: catMap['Beverages'], BrandId: brandMap['Coca-Cola'] },
      { name: 'Instant Coffee', purchasePrice: 8000, sellingPrice: 12000, barcode: '55667788', CategoryId: catMap['Food'], BrandId: brandMap['Nestle'] },
      { name: 'Running Shoes', purchasePrice: 45000, sellingPrice: 85000, barcode: '99001122', CategoryId: catMap['Clothing'], BrandId: brandMap['Nike'] },
      { name: 'Bluetooth Speaker', purchasePrice: 120000, sellingPrice: 180000, barcode: '44556677', CategoryId: catMap['Electronics'], BrandId: brandMap['Sony'] }
    ];
